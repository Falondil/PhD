...
massscaling = 0.02 # how many earth masses to start with
...
Ppaperlabel = ['',' - '+PCpaper, ' - '+PNpaper] # label figures with the part. coef. used
...
# MCtot0 = 600*1e-6*earthmass # Alt 1. 600 ppmw total estimated from Anders2021 or AnatomyIII. 27 ppmw of total planet mass of Venus lies in atmosphere (google). "The total amount of carbon in our planet is relatively poorly constrained."
# MCtot0 = 12/44*(526*1e-6+coremassfraction*0.3/100)*earthmass # Alt 2. Marty2012 for 526 ppm. Chen2014 for 0.3wt% C in bulk core (0.2-1wt% from cited papers). 12/44 conversion factor since we count mass of carbon in terms of CO2. WRONG FACTOR
