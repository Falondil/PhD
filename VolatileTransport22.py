...
relativeconvection = True # use Veestraeten2004 solution but for diffusion variable Mvol/Msil
...
cspread = 10 # allow the 1 std diffusion of particles from one layer to maximally spread _ layers
if explicit:
...
max_number_of_plots = 100 # plot at most 100 plots. Redefines plotstepspacing if necessary
