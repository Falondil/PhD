...
KN2 = KH2O # PLACEHOLDER. FIND A REAL VALUE
...
def Miatmeqfunc(Miatm0, AMUi, alphai, Ki, Msiltop, Misil0, method='fsolve'): # function to find the dissolution equilbrium solution of the mass of volatile species in the atmosphere 
...
Miatmstart = startingatmosphere(Matm, (Mvol[:,-1]/Msil[-1]), amui, alphai, Ki)
Miatmeqstart = Miatmeqfunc(Miatmstart, amui, alphai, Ki, Msil[-1], Mvol[:,-1])
