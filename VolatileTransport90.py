...
np.savetxt('pebblerate.out', protomasstimearray[:savingindex], delimiter=',') # 1d file. pebblerate for each saving time step
np.savetxt('diffusivity.out', protomasstimearray[:savingindex], delimiter=',') # 1d file. (enhanced) diffusivity for each saving time step
